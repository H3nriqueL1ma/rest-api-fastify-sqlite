...
server.post("/users", async (request, reply) => {
	...
	const { name, profession, birthdate } = request.body as {
		name: string,
		profession: string,
		birthdate: string
	};
...
server.get("/users", async (request: FastifyRequest<{ Querystring: { name?: string } }>, reply: FastifyReply) => {
...
server.put("/users/:id", async (request: FastifyRequest<{ Params: { id: string }}>, reply: FastifyReply) => {
